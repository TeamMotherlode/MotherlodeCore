...
public class MaterialToolsAndArmor {
    ...
    public MaterialToolsAndArmor(DefaultToolMaterial toolMaterial, ArmorMaterial armorMaterial) {
        ...
        this.SHOVEL = register(true, toolMaterial.getName() + "_shovel", new ShovelItem(toolMaterial, 1.5F, 3.0F, new Item.Settings().maxCount(1).group(MotherlodeUncategorized.ARMOUR_AND_TOOLS)));
        this.SWORD = register(true, toolMaterial.getName() + "_sword", new SwordItem(toolMaterial, 3, -2.4F, new Item.Settings().maxCount(1).group(MotherlodeUncategorized.ARMOUR_AND_TOOLS)));

        this.HELMET = register(false, toolMaterial.getName() + "_helmet", new ArmorItem(armorMaterial, EquipmentSlot.HEAD, new Item.Settings().group(MotherlodeUncategorized.ARMOUR_AND_TOOLS)));
        this.CHESTPLATE = register(false, toolMaterial.getName() + "_chestplate", new ArmorItem(armorMaterial, EquipmentSlot.CHEST, new Item.Settings().group(MotherlodeUncategorized.ARMOUR_AND_TOOLS)));
        this.LEGGINGS = register(false, toolMaterial.getName() + "_leggings", new ArmorItem(armorMaterial, EquipmentSlot.LEGS, new Item.Settings().group(MotherlodeUncategorized.ARMOUR_AND_TOOLS)));
        this.BOOTS = register(false, toolMaterial.getName() + "_boots", new ArmorItem(armorMaterial, EquipmentSlot.FEET, new Item.Settings().group(MotherlodeUncategorized.ARMOUR_AND_TOOLS)));
    }
