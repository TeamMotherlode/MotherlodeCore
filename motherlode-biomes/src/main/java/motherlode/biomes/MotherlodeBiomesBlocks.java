...
public class MotherlodeBiomesBlocks {
    ...
    private static final AssetGenerator DEFAULT_PROCESSOR = CommonAssets.FLAT_ITEM_MODEL.andThen(CommonAssets.PLANT);
    ...
    private static Block register(String name, Block block, AssetGenerator p) {
        ...
        if(p != null) MotherlodeAssets.addGenerator(id, p);
        MotherlodeData.addGenerator(id, CommonData.DEFAULT_BLOCK_LOOT_TABLE);

        return block;
    }

    public static AssetGenerator flatItemModel(String textureName) {
