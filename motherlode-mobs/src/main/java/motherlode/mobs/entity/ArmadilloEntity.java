...
public class ArmadilloEntity extends AnimalEntity implements IAnimatedEntity {
    ...
    */
    ...
    static class ArmadilloFleeGoal<T extends LivingEntity> extends FleeEntityGoal<T> {
        ...
        /* constructor */
        ArmadilloFleeGoal(ArmadilloEntity mob, Class<T> fleeFromType, float distance, double slowSpeed, double fastSpeed) {
    ...
    static class ArmadilloEscapeDangerGoal extends EscapeDangerGoal {
        ...
        // constructor
        ArmadilloEscapeDangerGoal(ArmadilloEntity mob, double speed) {
            super(mob, speed);
            armadilloEntity = mob;
        }
