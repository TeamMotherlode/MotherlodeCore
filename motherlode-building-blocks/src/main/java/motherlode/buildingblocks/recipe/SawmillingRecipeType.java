...
public class SawmillingRecipeType implements RecipeType<SawmillingRecipe>, DataProcessor {
    ...
    public void accept(ArtificeResourcePack.ServerResourcePackBuilder pack, Identifier id) {
        ...
        for (Pair<String, String> pair : logAndWoodPairs) {
            ...
            add(pack, "oak_" + log + "_to_bowls", new Identifier("oak_" + log), new Identifier("bowl"), 4);
            add(pack, "oak_" + log + "_to_crafting_tables", new Identifier("oak_" + log), new Identifier("crafting_table"));
            ...
            add(pack, "oak_" + log + "_to_fence_gates", new Identifier("oak_" + log), new Identifier("oak_fence_gate"));
        ...
        add(pack, "oak_planks_to_bowls", new Identifier("oak_planks"), new Identifier("bowl"));
