...
public abstract class CutterScreen extends HandledScreen<CutterScreenHandler> {
    ...
    public CutterScreen(CutterScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        List<? extends CuttingRecipe> availableRecipes = handler.getAvailableRecipes();
