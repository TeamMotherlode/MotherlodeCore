...
public class RedstoneTransmitterGuiDescription extends SyncedGuiDescription {
    ...
    public RedstoneTransmitterGuiDescription(int syncId, PlayerInventory inventory, ScreenHandlerContext context) {
        ...
        for (int i = 0; i < 9; i++) {
            WSprite gem = new WSprite(Motherlode.id(MotherlodeRedstoneMod.MODID, "textures/gui/container/gem.png"));
            panel.add(gem, 38 + (i * 18 - ((i / 3) * 54)), 26 + ((i / 3) * 18), 14, 11);
            gems.add(gem);

            WSprite miniGemTop = new WSprite(Motherlode.id(MotherlodeRedstoneMod.MODID, "textures/gui/container/white.png"));
            panel.add(miniGemTop, 112 + (i * 4 - ((i / 3) * 12)), 25 + ((i / 3) * 4), 1, 1);

            WSprite miniGemBottom = new WSprite(Motherlode.id(MotherlodeRedstoneMod.MODID, "textures/gui/container/white.png"));
        ...
        for (int i = 0; i < blockInventory.size(); i++) {
            if (blockInventory.getStack(i).isEmpty()) {
                gems.get(i).setImage(Motherlode.id(MotherlodeRedstoneMod.MODID, "textures/gui/container/gem.png"));
                miniGemsTop.get(i).setImage(Motherlode.id(MotherlodeRedstoneMod.MODID, "textures/gui/container/empty.png"));
