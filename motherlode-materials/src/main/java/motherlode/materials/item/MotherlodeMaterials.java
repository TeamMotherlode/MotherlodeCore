...
public class MotherlodeMaterials {
    ...
    public static final DefaultToolMaterial SILVER_TOOLS =
        new DefaultToolMaterial("silver", 400, 2, 16, 6.5f, 2.5F, Ingredient.ofItems(MotherlodeMaterialsItems.SILVER_INGOT));
    public static final DefaultToolMaterial CHARITE_TOOLS =
        new DefaultToolMaterial("charite", 3000, 5, 12, 10, 5, Ingredient.ofItems(MotherlodeMaterialsItems.CHARITE_INGOT));
    public static final DefaultToolMaterial ECHERITE_TOOLS =
        new DefaultToolMaterial("echerite", 5000, 6, 16, 11.5f, 6, Ingredient.ofItems(MotherlodeMaterialsItems.ECHERITE_INGOT));
    public static final DefaultToolMaterial TITANIUM_TOOLS =
        new DefaultToolMaterial("titanium", 7500, 7, 10, 12, 7, Ingredient.ofItems(MotherlodeMaterialsItems.TITANIUM_INGOT));
